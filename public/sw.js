const CACHE='thuishub-app-reference-ui-v1';
self.addEventListener('install',event=>event.waitUntil(caches.open(CACHE).then(cache=>cache.addAll(['/','/manifest.webmanifest','/brand/thuishub-icon-192.png']))));
