...
Uitvoer, wanneer SDK en certificaat aanwezig zijn: `release\ThuisHub-Samsung-TV-1.2.3.wgt`. Zonder deze lokale vereisten stopt het script veilig en blijft de volledige bron beschikbaar. Samsung's officiële [Web App Guide](https://developer.samsung.com/smarttv/develop/tools/webapp/webapp-guide.html) beschrijft packaging en testen.
