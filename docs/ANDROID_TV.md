...
Uitvoer: `release\ThuisHub-Android-TV-1.2.2.apk`. Dit is een lokaal debug-ondertekende APK voor sideloadtests, geen Play Store-release. Installeer bijvoorbeeld met `adb install -r <apk>` op een apparaat waarvoor USB/netwerkdebugging bewust is ingeschakeld.
